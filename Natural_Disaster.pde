...
void createExplosion(NaturalDisaster d) { 
  noStroke();
  fill(237, 67, 29);
  triangle(d.pos.x-5, d.pos.y, d.pos.x+5, d.pos.y, d.pos.x, d.pos.y-25);
  fill(207, 67, 29);
  triangle(d.pos.x, d.pos.y, d.pos.x-10, d.pos.y, d.pos.x-20, d.pos.y-20);
  triangle(d.pos.x, d.pos.y, d.pos.x+10, d.pos.y, d.pos.x+20, d.pos.y-20);
}
